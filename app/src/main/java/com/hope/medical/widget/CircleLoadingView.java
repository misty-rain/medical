...
import com.hope.medical.utils.ImageUtil;


/**
 * 自定义lodingview，采用5.0 + 样式
 *
 *
 */
public class CircleLoadingView extends View {
	...
	public CircleLoadingView(Context context, AttributeSet attrs) {
		...
		mLoadingPaint.setStrokeWidth(ImageUtil.dp2px(getContext(), 3));
		radius = ImageUtil.dp2px(getContext(), 11);
