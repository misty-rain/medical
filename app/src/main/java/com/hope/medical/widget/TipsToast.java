...
public class TipsToast extends Toast {
    ...
    public static TipsToast makeText(Context context, CharSequence text, int iconResId, int duration) {
    ...
    public static TipsToast makeText(Context context, int resId, int iconResId, int duration) throws Resources.NotFoundException {
        return makeText(context, context.getResources().getText(resId), iconResId, duration);
    }
